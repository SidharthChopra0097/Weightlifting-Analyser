...
train_angles, test_angles, train_labels, test_labels = train_test_split(angles_all, labels_all, test_size=0.2, random_state=42)
train_angles, val_angles, train_labels, val_labels = train_test_split(train_angles, train_labels, test_size=0.2, random_state=42)